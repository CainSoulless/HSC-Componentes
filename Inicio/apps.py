...
class JuegosConfig(AppConfig):
    ...
    def ready(self):
        # Conectar la señal para poblar las tablas
        post_migrate.connect(poblar_tablas, sender=self)

    from myapp.models import Categoria, Juego, Tarjeta, MetodosPago
    
    def poblar_tablas(sender, **kwargs):
        # Verificar si ya hay datos, para no duplicar el poblamiento
